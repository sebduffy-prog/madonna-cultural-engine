// Audience Bridge — Word doc upload/retrieve for synthetic audience conversations

import { kvGet, kvSet } from "../../lib/kv";

const CACHE_KEY = "audience_bridge_docs";
...
export default async function handler(req, res) {
  ...
  if (req.method === "POST") {
    ...
    const doc = {
      id: uuid(),
      name,
      content, // Plain text extracted client-side
